...
public class testIages {
    ...
    public void sphereSpot() {
        ...
        scene1.background = new Color(100,128,128);


        ImageWriter imageWriter = new ImageWriter("test1", 500, 500);
        ImageWriter imageWriter2 = new ImageWriter("test2", 500, 500);
        ImageWriter imageWriter3 = new ImageWriter("test3", 500, 500);
        ImageWriter imageWriter4 = new ImageWriter("test4", 500, 500);
        ImageWriter imageWriter5 = new ImageWriter("test5", 500, 500);
        ImageWriter imageWriter6 = new ImageWriter("test6", 500, 500);
        camera1.setImageWriter(imageWriter) //
                .setRayTracer(new RayTracerBasic(scene1)) //
                .renderImage() //
                .writeToImage(); //
      //  camera1.moveCamera(new Vector(1, 0, 0),10);
        camera1.rotateCamera(90);
        camera1.setImageWriter(imageWriter2) //
                        .setRayTracer(new RayTracerBasic(scene1)) //
                        .renderImage() //
                        .writeToImage(); //
        camera1.rotateCamera(180);
        camera1.setImageWriter(imageWriter3) //
                        .setRayTracer(new RayTracerBasic(scene1)) //
                                .renderImage() //
                                        .writeToImage(); //camera1.rotateCamera(1,0,0);
        camera1.rotateCamera(-90);
